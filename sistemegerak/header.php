				...
				<nav class="navbar navbar-expand-lg navbar-light bg-light toggled">
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
						<ul class="navbar-nav nav-tabs mr-auto">
							...
							<li class="nav-item">
								...
								while($row = $result -> fetch_assoc()) {
									if($row['staffposition'] == "Admin") {?>
										<a class="nav-link" href="../admin/index/staffinformation.php">
							...
							<li class="nav-item">
								<a class="btn btn-outline-secondary ml-3" href="http://localhost/Project/admin/include/logout.inc.php">Daftar keluar
