  ...
  <br>
 	...
 	<div class="form-main">
 		<section class="section-default">
			...
			<button id="logoutbtn" class="btn btn-secondary" href="http://localhost/Project/admin/include/logout.inc.php">
			...
			Logout</button>
			<a id="adminbtn" class="btn" type="submit" href="../admin/index/staffinformation.php">
